...
const DEFAULT_LOG_WINSTON_LEVLS: WinstonLogLevel = 'info';

/**
 * The log output level is based on the Nest configuration extension and works with winston. Since the log level conflicts with the definition of winston, it needs to be converted to info.
...
export class LoggerService implements NestLoggerService {
  ...
  constructor(
    ...
    //File output level
    !this.options.level && (this.options.level = DEFAULT_LOG_WINSTON_LEVLS);
